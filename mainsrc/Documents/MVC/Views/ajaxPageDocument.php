...
<?php foreach($allDocuments As $item) : ?>
    ...
    <div style="width: 200px; height: 180px" class="card ">
    ...
    <form style="width: 225px;" method="Post" class="row" action="/Documents" id="newDocumentForm">
        ...
        <button style="height: 180px;" type="submit" class="btn btn-success" name="newDocument" value="send">New Document Cover </button>
    </form>
