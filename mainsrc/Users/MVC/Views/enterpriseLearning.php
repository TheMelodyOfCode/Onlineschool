...
<section class=" mt-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-5 col-md-8 mx-auto">
        <h1 class="fw-light">Learning Area Enterprise</h1>
...
<div class="container px-4 py-5" id="hanging-icons">
  <h2 class="pb-2 border-bottom">Enterprise Section </h2>
...
<div class="container px-4 py-5" id="custom-cards">
  <h2 class="pb-2 border-bottom">Custom Learning Enterprise Section Cards</h2>
...
<div class="container px-4 py-5" id="icon-grid">
  ...
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
    <div class="col d-flex align-items-start">
      ...
      <div>
        <h4 class="fw-bold mb-0">Enterprise Section title</h4>
