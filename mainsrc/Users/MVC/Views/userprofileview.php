...
<div class="modal modal-tour position-static d-block bg-secondary py-5" tabindex="-1" role="dialog" id="modalTour">
  <div class="modal-dialog" role="document">
    <div class="modal-content rounded-6 shadow">
      ...
      <div class="form-text text-primary">Firstname & Lastname</div>
      <h2 class="fw-bold mb-0"><?php echo $singleUser->firstname;?> <?php echo $singleUser->lastname;?></h2>
      <div class="form-text text-primary">Status:</div>
        <h4>(<?php echo $singleUser->status;?>)</h4>
        <div class="form-text text-primary">Username:</div>
        <h3 class="fw-bold mb-0"><?php echo $singleUser->username;?></h3>
        ...
        <ul class="d-grid gap-4 my-5 list-unstyled">
          ...
          <li class="d-flex gap-4">
            ...
            <div>
            <div class="form-text text-primary">Email:</div>
